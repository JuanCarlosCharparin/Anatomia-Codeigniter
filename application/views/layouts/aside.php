                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url();?>mantenimiento/Pacientes"><i class="fa fa-circle-o"></i> Pacientes</a></li>
                            <li><a href="<?php echo base_url();?>mantenimiento/Estudios"><i class="fa fa-circle-o"></i> Estudios</a></li>
